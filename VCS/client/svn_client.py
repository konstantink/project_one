...
class Client(object):
    ...
    def __init__(self, user, password, urls):
        ...
        self.client.callback_get_login = self.get_login(lambda *args: True, self.user, self.password, True)
        self.client.callback_get_log_message = self.get_log_message(lambda *args: True, self.log_message)
